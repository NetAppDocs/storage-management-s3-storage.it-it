...
.Cosa c'è dopo?
È possibile modificare alcune impostazioni del bucket direttamente dalla console NetApp facendo clic suimage:button-horizontal-more.gif["il pulsante \"Altro\" con tre punti"] per un secchio. link:task-change-s3-bucket-settings.html["Vai qui per i dettagli"] .
